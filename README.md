...
[![Travis Build](https://travis-ci.org/qredo/go-proto-validators.svg)](https://travis-ci.org/qredo/go-proto-validators)
...
import "github.com/qredo/go-proto-validators/validator.proto";
...
```sh
go get github.com/qredo/go-proto-validators/protoc-gen-govalidators
```
